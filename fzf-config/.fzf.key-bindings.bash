...
if [[ ! -o vi ]]; then
  ...
  if [ $BASH_VERSINFO -gt 3 ]; then
    ...
    bind '"\C-f": " \C-u \C-a\C-k`__fzf_select__`\e\C-e\C-y\C-a\C-y\ey\C-h\C-e\er \C-h"'
  fi
  ...
  if [ $BASH_VERSINFO -gt 3 ]; then
    ...
    bind '"\C-f": "\C-x\C-a$a \C-x\C-addi`__fzf_select_tmux__`\C-x\C-e\C-x\C-a0P$xa"'
  else
    bind '"\C-f": "\C-x\C-a$a \C-x\C-addi`__fzf_select__`\C-x\C-e\C-x\C-a0Px$a \C-x\C-r\C-x\C-axa "'
  fi
